...
export default function Home() {
  ...
  const TECH_STACK = [
    ...
    },
    {
      ...
      technologies: ["Java", "Spring Boot", "RESTful APIs", "Servlets & JSP", "Hibernate", "Microservices"]
    },
    {
      category: (<><span>01.03.02 / </span>DataBases</>),
      technologies: ["MySQL", "MongoDB", "PostGreSQL", "Redis",]
    },
    {
      category: (<><span>01.03.03 / </span>Tools & Other</>),
      technologies: ["Git", "GitHub", "Maven", "Postman", "Docker", , "JUnit", "VS Code", "Eclipse", "Intellij Idea"]
    },
    {
  ...
  const projects = [
    {
      id: "01",
      top_info: "Intern Projects",
      name: "RideConnect",
      page_link: "/projects/rideconnect",
      tech: ["Java 21",
        "Spring Boot",
        "Spring Security",
        "PostgreSQL",
  ...
  */
  ...
  const SOCIAL_LINKS = [
    ...
    {
      href: 'https://github.com/SuryaKDev',
